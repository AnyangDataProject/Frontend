    ...
    return (
      <div className="report-page">
        <main className="report-success">
          ...
          <span className="success-eyebrow">REPORT SUBMITTED</span>
          <h1>신고가 접수되었습니다.</h1>
          ...
          <div className="success-actions">
            ...
            <button className="success-primary" onClick={() => navigate("/my-reports")}>
              내 신고 확인
            </button>
          </div>
        </main>
  ...
  return (
    <div className="report-page">
      <main className="report-main">
        {/* 상단 지도 돌아가기 버튼 추가 */}
        <button type="button" className="report-back" onClick={() => navigate("/")}>
          <ArrowLeft size={16} />
          지도 돌아가기
        </button>
        ...
        <section className="report-title">
          <div>
            <span className="report-eyebrow">ROAD DAMAGE REPORT</span>
            <h1>도로파손 신고</h1>
            <p>도로파손 현장을 촬영하고 위치와 내용을 입력해주세요.</p>
          </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <section className="report-card">
            <div className="report-card-title">
              ...
              <div>
                <h2>파손 현장 사진</h2>
                <p>AI 분석을 위해 파손 부위가 잘 보이도록 촬영해주세요.</p>
              </div>
            </div>
            ...
            <div className="photo-upload-area">
              {images.map((image) => (
                <div className="uploaded-image" key={image.id}>
                  <img src={image.preview} alt="도로파손 신고 이미지" />
                  <button
                    type="button"
          ...
          <section className="report-card">
            <div className="report-card-title">
              <div className="report-number">02</div>
              <div>
                <h2>파손 유형</h2>
                <p>가장 가까운 파손 유형을 선택해주세요.</p>
              </div>
            </div>
              ...
              {DAMAGE_TYPES.map((type) => {
                ...
                return (
                  <button
                    key={type.value}
                    type="button"
                    className={`damage-type ${damageType === type.value ? "is-selected" : ""}`}
            ...
            <div className="ai-notice">
              ...
              <p>선택한 유형은 참고용입니다. 신고 사진은 AI가 별도로 분석하여 파손 유형을 판별합니다.</p>
            </div>
          </section>
          ...
          <section className="report-card">
            ...
            <div className="location-input-wrap">
              ...
              />
              <button type="button" className="location-button" onClick={handleCurrentLocation}>
                <Navigation size={15} />
                현재 위치
              </button>
            </div>
            ...
            <div className="location-map">
              ...
              {!markerPos && (
                <span className="map-label map-label--hint">지도를 눌러 위치를 선택하세요</span>
              )}
            </div>

            <p className="location-help">※ 지도를 클릭하면 해당 위치의 주소가 자동으로 입력됩니다.</p>
          </section>

          {/* 04. Severity */}
          <section className="report-card">
            <div className="report-card-title">
              <div className="report-number">04</div>
              <div>
                <h2>파손 심각도</h2>
                <p>현재 도로 이용에 미치는 영향을 선택해주세요.</p>
              </div>
            </div>
              ...
              {SEVERITY_OPTIONS.map((option) => (
                <button
                  ...
                  className={`severity-option severity-${option.value} ${
                    severity === option.value ? "is-selected" : ""
                  }`}
          ...
          <section className="report-card">
            <div className="report-card-title">
              <div className="report-number">05</div>
              <div>
                <h2>상세 내용</h2>
                <p>
                  파손 상태나 주변 상황을 알려주세요.
            ...
            />
            <div className="text-count">{detail.length} / 500</div>
          </section>
          ...
          <div className="report-submit-area">
            <button type="button" className="report-cancel" onClick={() => navigate(-1)}>
              취소
            </button>
