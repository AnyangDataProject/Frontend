...
const INQUIRY_TYPES = [
  {
    value: "report",
    label: "신고 관련 문의",
    description: "접수한 신고에 대해 문의합니다.",
  },
  {
    value: "result",
    label: "처리 결과 문의",
    description: "처리 결과 또는 진행 상황을 문의합니다.",
  },
  {
    value: "service",
    label: "서비스 이용 문의",
    description: "로드센스 이용 방법을 문의합니다.",
  },
  {
    value: "etc",
    label: "기타 민원",
    description: "기타 의견이나 민원을 접수합니다.",
  },
];
      ...
      <div className="inq-page">
        <header className="inq-header">
          <div className="inq-header-inner">
            <button
              ...
              onClick={() => navigate("/")}
            >
              <div className="inq-logo-mark">
                <MessageSquareText size={19} />
              </div>

              <div>
                <div className="inq-logo-title">
                  로드센스
                </div>
                <div className="inq-logo-sub">
                  안양시 AI 도로파손 탐지 서비스
                </div>
              </div>
            </button>

            <nav className="inq-nav">
        ...
        <main className="inq-success-page">
          <div className="inq-success-card">
            ...
            <p className="inq-success-eyebrow">
              SUBMISSION COMPLETE
            </p>
            ...
            <div className="inq-success-buttons">
              <button
                className="inq-secondary-button"
                onClick={() => navigate("/")}
              >
                지도 돌아가기
              </button>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="inq-consent">
                ...
                <label>
                  ...
                  <span className="inq-custom-checkbox">
                    {agree && "✓"}
                  </span>
